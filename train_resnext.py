...
from utils.train_resnext_model import train
...
def init_parse():
    ...
    parser.add_argument('--save-dir', type=Path, default='ResNeXt-101-32x8d-Finetune')
    ...
    parser.add_argument('--w-base', type=int, default=64)
